...
+ (NSString*)timeChangeTimerWithSeconds:(NSInteger)seconds {
    ...
    NSInteger s = seconds %60;
    NSString * hour = h<= 9 ? [NSString stringWithFormat:@"0%ld",(long)h] :[NSString stringWithFormat:@"%ld",(long)h];
    NSString *day = d <= 9 ? [NSString stringWithFormat:@"%0ld",(long)d] : [NSString stringWithFormat:@"%ld",(long)d];
    NSString *minite = m <= 9 ? [NSString stringWithFormat:@"0%ld",(long)m] : [NSString stringWithFormat:@"%ld",(long)m];
    NSString *second = s <= 9 ? [NSString stringWithFormat:@"0%ld",(long)s] : [NSString stringWithFormat:@"%ld",(long)s];
    if ([day integerValue]>0) {
...
+ (NSAttributedString*)attributionTimeChangeWithSeconds:(NSInteger)seconds isMinite:(BOOL)isMinite {
    ...
    NSInteger m = temp1 % 60;
    NSInteger s = seconds %60;
    NSString * hour = [NSString stringWithFormat:@"%ld",(long)h];// h< 9 ? [NSString stringWithFormat:@"0%ld",(long)h] :[NSString stringWithFormat:@"%ld",(long)h];
    NSString *day = d < 9 ? [NSString stringWithFormat:@"%ld",(long)d] : [NSString stringWithFormat:@"%ld",(long)d];
    ...
    NSMutableAttributedString *atr = [[NSMutableAttributedString alloc] initWithString:all];
    NSRange hourRang = [all rangeOfString:minite];
    [atr addAttributes:@{NSForegroundColorAttributeName:[UIColor whiteColor],NSFontAttributeName:SYSTEMFONT(10)} range:NSMakeRange(0, all.length)];
    [atr addAttributes:@{NSFontAttributeName:SYSTEMFONT(20)} range:hourRang];
    return [[NSAttributedString alloc] initWithAttributedString:atr];
}
...
+ (NSString*)timeChangeWithSecondsFormat:(NSInteger)seconds {
    ...
    NSInteger m = temp1 % 60;
    NSInteger s = seconds %60;
    NSString * hour = h< 10 ? [NSString stringWithFormat:@"0%ld",(long)h] :[NSString stringWithFormat:@"%ld",(long)h];
    NSString *day = d < 10 ? [NSString stringWithFormat:@"%ld",(long)d] : [NSString stringWithFormat:@"%ld",(long)d];
    NSString *minite = m < 10 ? [NSString stringWithFormat:@"0%ld",(long)m] : [NSString stringWithFormat:@"%ld",(long)m];
    NSString *second = s < 10 ? [NSString stringWithFormat:@"0%ld",(long)s] : [NSString stringWithFormat:@"%ld",(long)s];
    if ([day integerValue]>0) {
        return [NSString stringWithFormat:@"%@:%@:%@:%@",day,hour,minite,second];
    }
    return [NSString stringWithFormat:@"%@:%@:%@",hour,minite,second];
...
+ (NSString *)evaluateStarTime:(NSString *)starTime endTime:(NSString *)eTime {
    ...
    if ([yearStr isEqualToString:nowYearStr]) {
        // 同一年
        //是否同一天
        if ([[theDay substringWithRange:NSMakeRange(5, 6)] isEqualToString:[eDay substringWithRange:NSMakeRange(5, 6)]]) {
            ...
            return [NSString stringWithFormat:@"%@ %@-%@ %@",[theDay substringWithRange:NSMakeRange(5, 6)],[theDay substringWithRange:NSMakeRange(12, 5)],[eDay substringWithRange:NSMakeRange(5, 6)],[eDay substringWithRange:NSMakeRange(12, 5)]];
        }
    } else {
        return [NSString stringWithFormat:@"%@-%@",theDay,eDay];
    }
}
