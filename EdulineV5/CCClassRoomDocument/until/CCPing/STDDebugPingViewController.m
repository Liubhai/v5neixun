...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = HDClassLocalizeString(@"Ping网络") ;
    ...
    self.textField.placeholder = HDClassLocalizeString(@"请输入IP地址或者域名") ;
    self.textField.text = @"ccapi.csslcloud.net";
