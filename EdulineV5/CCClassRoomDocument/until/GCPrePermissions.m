...
@interface GCPrePermissions () <UIAlertViewDelegate>
...
//        [self showNoAutherOrRefuseAutherWithMessage:[NSString stringWithFormat:HDClassLocalizeString(@"请在iPhone的“设置-通知”选项中，\r允许“%@”发送通知。") ,appName]];
//    }else{
                 ...
                 completionHandler:(GCPrePermissionCompletionHandler)completionHandler
{
    ...
    if (status == AVAuthorizationStatusNotDetermined) {
        ...
        [HDSTool showAlertTitle:requestTitle msg:message cancel:denyButtonTitle other:@[grantButtonTitle] completion:^(BOOL cancelled, NSInteger buttonIndex) {
            if (cancelled) {
                // User said NO, jerk.
                [self fireAVPermissionCompletionHandlerWithType:100];
            } else {
                // User granted access, now show the REAL permissions dialog
                [self showActualAVPermissionAlertWithType:200];
            }
        }];
        ...
        if (mediaType == GCAVAuthorizationTypeCamera) {
            [self showNoAutherOrRefuseAutherWithMessage:[NSString stringWithFormat:HDClassLocalizeString(@"请在iPhone的”设置-隐私-相机”选项中，\r允许“%@”访问您的相册。") ,appName]];
        }else{
            [self showNoAutherOrRefuseAutherWithMessage:[NSString stringWithFormat:HDClassLocalizeString(@"请在iPhone的”设置-隐私-麦克风”选项中，允许“%@”访问您的麦克风。") ,appName]];
        }
    }else{
        if (completionHandler) {
                     ...
                     completionHandler:(GCPrePermissionCompletionHandler)completionHandler
{
    ...
    if (status == ALAuthorizationStatusNotDetermined) {
        ...
        NSString *appName = [[NSBundle mainBundle].infoDictionary valueForKey:@"CFBundleDisplayName"];
        if (!appName) appName = [[NSBundle mainBundle].infoDictionary valueForKey:@"CFBundleName"];
        [self showNoAutherOrRefuseAutherWithMessage:[NSString stringWithFormat:HDClassLocalizeString(@"请在iPhone的”设置-隐私-相机”选项中，\r允许“%@”访问您的相机。") ,appName]];
    }else{
        if (completionHandler) {
...
//        NSString *appName = [[NSBundle mainBundle].infoDictionary valueForKey:@"CFBundleDisplayName"];
//        if (!appName) appName = [[NSBundle mainBundle].infoDictionary valueForKey:@"CFBundleName"];
//        [self showNoAutherOrRefuseAutherWithMessage:[NSString stringWithFormat:HDClassLocalizeString(@"请在iPhone的”设置-隐私-通讯录”选项中，\r允许“%@”访问您的通讯录。") ,appName]];
//    }else{
//        if (completionHandler) {
...
//            [self showNoAutherOrRefuseAutherWithMessage:[NSString stringWithFormat:HDClassLocalizeString(@"请在iPhone的”设置-隐私-日历”选项中，\r允许“%@”访问您的日历。") ,appName]];
//        }else{
//            [self showNoAutherOrRefuseAutherWithMessage:[NSString stringWithFormat:HDClassLocalizeString(@"请在iPhone的”设置-隐私-提醒事项”选项中，允许“%@”访问您的提醒事项。") ,appName]];
//        }
//    }else{
//        if (completionHandler) {
...
//        NSString *appName = [[NSBundle mainBundle].infoDictionary valueForKey:@"CFBundleDisplayName"];
//        if (!appName) appName = [[NSBundle mainBundle].infoDictionary valueForKey:@"CFBundleName"];
//        [self showNoAutherOrRefuseAutherWithMessage:[NSString stringWithFormat:HDClassLocalizeString(@"请在iPhone的”设置-隐私-位置”选项中，\r允许“%@”访问您的位置。") ,appName]];
//    }else{
//        if (completionHandler) {
...
- (void)showNoAutherOrRefuseAutherWithMessage:(NSString*)message
{
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"9.0")) {
        ...
        UIAlertView *enterSettings = [[UIAlertView alloc]initWithTitle:HDClassLocalizeString(@"提示") message:message delegate:self cancelButtonTitle:HDClassLocalizeString(@"暂不") otherButtonTitles:HDClassLocalizeString(@"设置") , nil];
        enterSettings.tag = 100;
        [enterSettings show];
    }else{
    
        UIAlertView *photoAlertviews = [[UIAlertView alloc] initWithTitle:HDClassLocalizeString(@"提示") message:message delegate:self cancelButtonTitle:HDClassLocalizeString(@"确定") otherButtonTitles:nil];
