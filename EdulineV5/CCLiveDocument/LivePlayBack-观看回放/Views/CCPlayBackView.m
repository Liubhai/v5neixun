...
- (void)newSetupUI {
    ...
    [self.topShadow mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.top.mas_equalTo(weakSelf.controlView);
    ...
    [self.backButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(weakSelf.topShadow.mas_left);
        make.top.mas_equalTo(weakSelf.topShadow.mas_top);
    ...
    [self.pauseButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(weakSelf.bottomShadow.mas_top);
...
- (void)layoutUI:(BOOL)screenLandScape {
    ...
    if (screenLandScape == YES) { /// 横屏
        ...
        /** 离线回放 */
        if (self.isOffline == YES || self.qualityBtn.hidden == YES) {
            if (self.changeButton.hidden == YES) {
                /** 重置倍速按钮 */
                [self.speedButton mas_remakeConstraints:^(MASConstraintMaker *make) {
                    make.centerY.mas_equalTo(weakSelf.pauseButton);
                    make.right.mas_equalTo(weakSelf.bottomShadow.mas_right).offset(-(15+offset));
                    make.width.mas_equalTo(44);
                    make.height.mas_equalTo(44);
                }];
            }else {
                ...
                [self.speedButton mas_remakeConstraints:^(MASConstraintMaker *make) {
                    make.centerY.mas_equalTo(weakSelf.pauseButton);
                    make.right.mas_equalTo(weakSelf.changeButton.mas_left).offset(-15);
                    make.width.mas_equalTo(44);
                    make.height.mas_equalTo(44);
                }];
            }
            ...
            [self.speedButton mas_remakeConstraints:^(MASConstraintMaker *make) {
                make.centerY.mas_equalTo(weakSelf.pauseButton);
                make.right.mas_equalTo(weakSelf.qualityBtn.mas_left).offset(-15);
                make.width.mas_equalTo(44);
                make.height.mas_equalTo(44);
            }];
        }
