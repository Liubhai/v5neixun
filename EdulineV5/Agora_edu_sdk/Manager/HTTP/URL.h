...
#define HTTP_ENTER_ROOM @"%@/edu/v1/apps/%@/room/entry"// 进入直播间

// /edu/v1/apps/{appId}/room/exit
#define HTTP_LEFT_ROOM @"%@/edu/v1/apps/%@/room/%@/exit"// 退出直播间

// http: get or update global state
// /edu/v1/apps/{appId}/room/{roomId}
#define HTTP_ROOM_INFO @"%@/edu/v1/apps/%@/room/%@" // 获取直播间信息
...
// /edu/v1/apps/{appId}/room/{roomId}
#define HTTP_WHITE_ROOM_INFO @"%@/edu/v1/apps/%@/room/%@/board"// 直播间白板信息

// http: update user info
// /edu/v1/apps/{appId}/room/{roomId}/user/{userId}
#define HTTP_UPDATE_USER_INFO @"%@/edu/v1/apps/%@/room/%@/user/%@"// 更新直播间某个用户信息

// http: im
// /edu/v1/apps/{appId}/room/{roomId}/chat
#define HTTP_USER_INSTANT_MESSAGE @"%@/edu/v1/apps/%@/room/%@/chat" // 直播间发送一条新消息

// http: covideo
// /edu/v1/apps/{appId}/room/{roomId}/covideo
#define HTTP_USER_COVIDEO @"%@/edu/v1/apps/%@/room/%@/covideo" // 大班课直播间连麦操作

// http: get replay info
// /edu/v1/apps/{appId}/room/{roomId}/record/{recordId}
#define HTTP_GET_REPLAY_INFO @"%@/edu/v1/apps/%@/room/%@/record/%@" // 直播间回放信息
