...
- (void)setMyCertificateListCellInfo:(NSDictionary *)dict {
    _fromLabel.text = [NSString stringWithFormat:@"来源：%@",dict[@"course_title"]];
    _titleLabel.text = [NSString stringWithFormat:@"%@",dict[@"cert_title"]];
    _getTimeLabel.text = [NSString stringWithFormat:@"获得时间：%@",[EdulineV5_Tool timeFormatterYYYYMMDD:[NSString stringWithFormat:@"%@",dict[@"create_time"]]]];
}
