...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([ShowUserFace isEqualToString:@"1"] && ([[NSString stringWithFormat:@"%@",self.dataSource[indexPath.row][@"course_type"]] isEqualToString:@"1"] || [[NSString stringWithFormat:@"%@",self.dataSource[indexPath.row][@"course_type"]] isEqualToString:@"4"])) {
