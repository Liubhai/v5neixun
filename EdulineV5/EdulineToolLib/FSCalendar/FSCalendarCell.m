...
- (void)layoutSubviews
{
    ...
    self.contentView.fs_height = 3.5;//self.fs_height;
    self.contentView.fs_width = 3.5;//(self.numberOfEvents*2-1)*diameter;
...
- (void)layoutSublayersOfLayer:(CALayer *)layer
{
    ...
    if (layer == self.layer) {
        ...
        CGFloat diameter = 3.5;//MIN(MIN(self.fs_width, self.fs_height),FSCalendarMaximumEventDotDiameter);
