...
@protocol FSCalendarHeaderViewDelegate <NSObject>
...
@property (weak, nonatomic) id<FSCalendarHeaderViewDelegate> delegate;

@property (weak, nonatomic) FSCalendarCollectionView *collectionView;
@property (weak, nonatomic) FSCalendarHeaderLayout *collectionViewLayout;
@property (weak, nonatomic) FSCalendar *calendar;
@property (weak, nonatomic) UIButton *backTodayButton;
