...
@property (nonatomic, assign) BOOL unHiddenCoverImage;
@property (nonatomic, assign) BOOL faceVerifyCanPlay;
@property (nonatomic, strong) NSArray *trackInfoArray;
@property (nonatomic, assign) int trackInfoIndex;
