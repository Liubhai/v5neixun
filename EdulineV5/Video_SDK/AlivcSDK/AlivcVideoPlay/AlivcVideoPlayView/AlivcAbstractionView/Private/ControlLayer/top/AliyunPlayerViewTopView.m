...
- (UIButton *)backButton{
    if (!_backButton){
        ...
        [_backButton setImage:backImage forState:0];
...
- (void)layoutSubviews{
    ...
    self.backButton.frame = CGRectMake(0, 0, ALYPVTopViewBackButtonWidth + 2*ALYPVTopViewTitleLabelMargin, height);
    ...
    self.titleLabel.frame = CGRectMake(CGRectGetMaxX(self.backButton.frame), 0, titleWidth, height);
