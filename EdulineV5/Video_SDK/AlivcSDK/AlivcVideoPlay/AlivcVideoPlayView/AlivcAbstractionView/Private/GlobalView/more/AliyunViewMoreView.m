...
- (UILabel *)speedLabel{
    if (!_speedLabel) {
        ...
        _speedLabel.text = NSLocalizedString(@"倍速播放", nil);
...
- (void)layoutSubviews{
    ...
    [_airplayBtn setTitle:NSLocalizedString(@"投屏" , nil) forState:UIControlStateNormal];
    ...
    [_barrageBtn setTitle:NSLocalizedString(@"弹幕设置", nil) forState:UIControlStateNormal];
