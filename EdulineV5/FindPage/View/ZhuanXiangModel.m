...
{
    if ([property.name isEqualToString:@"course_id"] || [property.name isEqualToString:@"id"] || [property.name isEqualToString:@"topic_count"] || [property.name isEqualToString:@"answered_num"]) {
