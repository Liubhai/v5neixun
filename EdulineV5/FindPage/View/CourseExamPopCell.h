...
@class CourseExamPopCell;

@protocol CourseExamPopCellDelegate <NSObject>

@optional
/** 填空输入 */
- (void)courseExamPopCellinputTextFieldSure:(ExamDetailModel *)cellDetailModel cellOptionModel:(ExamDetailOptionsModel *)cellOptionModel answerCell:(CourseExamPopCell *)answerCell;
/** 完形填空选择 */
- (void)courseExamPopCellgapfillingChooseStatusChanged:(CourseExamPopCell *)answerCell button:(UIButton *)sender;

/** 人脸识别时候检测即将输入 */
- (void)courseExamPopCelltextFieldBegain:(UITextField *)textField;
- (void)courseExamPopCelltextViewBegain:(UITextView *)textView;

@end

@interface CourseExamPopCell : UITableViewCell<UITextFieldDelegate, UITextViewDelegate>

@property (assign, nonatomic) id<CourseExamPopCellDelegate> delegate;
...
- (void)setCourseExamPopCellAnswerInfo:(ExamDetailOptionsModel *)model mainExamDetail:(ExamDetailModel *)mainExamDetail  examDetail:(ExamDetailModel *)detailModel cellIndex:(NSIndexPath *)cellIndexPath;
