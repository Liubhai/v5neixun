...
- (void)makeSubView {
    ...
    _nameRightLabel.text = [V5_UserModel uname];
...
- (void)makeAgreeView {
    ...
    [_seleteBtn setImage:[[Image(@"checkbox_sel1") converToMainColor] converToMainColor] forState:UIControlStateSelected];
    [_seleteBtn setImage:[[Image(@"checkbox_sel1") converToMainColor] converToMainColor] forState:UIControlStateDisabled];
