...
- (void)makeSubView {
    ...
    NSArray *orderSortArray = @[@{@"image":@"pre_order_daizhifu",@"title":@"待支付"},@{@"image":@"pre_order_quxiao",@"title":@"已取消"},@{@"image":@"pre_order_fin",@"title":@"已完成"},@{@"image":@"pre_order_shenqing",@"title":@"申请退款"},@{@"image":@"pre_order_tuikuan",@"title":@"已退款"}];
